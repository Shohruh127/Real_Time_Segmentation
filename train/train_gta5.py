...
def main(args): 
    ...
    gta_train_loader = DataLoader(gta_train_dataset, batch_size=args.gta5_bs, shuffle=True, num_workers=4, pin_memory=True, drop_last=True)
    ...
    city_val_loader = DataLoader(city_val_dataset, batch_size=args.city_val_bs, shuffle=False, num_workers=4, pin_memory=True)
